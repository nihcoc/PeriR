...
I've always wanted an SDR. It feels like your a real hacker when you use an SDR to get those images from weather satellites, using ADS-B to find planes in your vicinity or listen to different transmissions at different frequencies. 
